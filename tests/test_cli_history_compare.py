...
@pytest.fixture
def local_repo(local_repo_path): # Adapted from test_main.py
...
class TestHistoryCommandCLI:
    ...
    def test_history_with_limit_n_cli(self, runner, local_repo):
        ...
        make_commit(repo, "fileA.txt", "contentA", commitA_msg)
    ...
    def test_history_limit_n_greater_than_commits_cli(self, runner, local_repo):
        ...
        commitA_oid_str = str(make_commit(repo, "another_A.txt", "content", commitA_msg))
